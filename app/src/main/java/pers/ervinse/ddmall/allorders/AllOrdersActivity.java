...
import pers.ervinse.ddmall.allorders.AllOrdersAdapter;
...
public class AllOrdersActivity extends Activity {
    ...
    private static final String TAG = pers.ervinse.ddmall.allorders.AllOrdersActivity.class.getSimpleName();
    ...
    public void firstFresh(List<Order> list) {
        handler.post(new Runnable() {
            ...
            public void run() {
                //创建类别循环视图适配器,加载数据
                adapter = new AllOrdersAdapter(list, mContext);
                //循环视图加载适配器
